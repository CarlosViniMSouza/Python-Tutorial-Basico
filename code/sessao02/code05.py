...
"""
Outro tipo de dados útil incorporado ao Python é o dicionário (consulte Tipos de mapeamento — dict). Dicionários às vezes são encontrados em outras línguas como “memórias associativas” ou “matrizes associativas”. 

Ao contrário das sequências, que são indexadas por um intervalo de números, os dicionários são indexados por chaves, que podem ser de qualquer tipo imutável; strings e números sempre podem ser chaves. 

Tuplas podem ser usadas como chaves se contiverem apenas strings, números ou tuplas; se uma tupla contiver qualquer objeto mutável direta ou indiretamente, ela não poderá ser usada como chave. 
...
Dos elementos constituinte em nosso dicionário
"""
